...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $name          = mysqli_escape_string($conn,$_POST['name']);
			$mobile        = mysqli_escape_string($conn,$_POST['number']);
      ...
      $sql   = "INSERT INTO appointment (`name`,`mobile`,`email`,`symptoms`,`date`,`department`,`gender`,`time`)
			          VALUES ('$name','$mobile','$email','$symptoms','$date','$department','$gender','$time')";
		...
		<div class="container">
					...
					<div class="book-appointment">
						<h4>Make an appointment</h4>
								...
								<div class="gaps" name="department">
									<p>Department</p>
