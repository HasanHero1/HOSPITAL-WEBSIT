		...
		<div class="header_agileinfo">
						<div class="w3_agileits_header_text">
							<ul class="top_agile_w3l_info_icons">
									...
									<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="itshasanhero@gmail.com">itshasanhero@gmail.come</a></li>
								</ul>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					...
					<ul id="m_nav_list" class="m_nav menu__list">
						...
						<li class="m_nav_item menu__item menu__item--current" id="moble_nav_item_6"> <a href="contact.php" class="menu__link"> Contact </a> </li>
					</ul>
				</nav>
               ...
               <div class="col-md-4 contact-grid ">
				...
				<div class="col-md-4 contact-grid">
					<div class="contact-grid3 w3l">
						...
						<div class="con-w3l-info">
						  <h4>Email</h4>
						  <p><a href="itshasanhero@gmail.com">itshasanhero@gmail.com</a>
