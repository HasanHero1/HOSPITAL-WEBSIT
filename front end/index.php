...
<html lang="zxx">
<head>
<title>Health Plus a Medical Category Bootstrap Responsive Website Template</title>
<!-- for-meta-tags-->
		...
		<div class="header_agileinfo">
						<div class="w3_agileits_header_text">
								<ul class="top_agile_w3l_info_icons">
									<li><i class="fa fa-home" aria-hidden="true"></i>Dhaka, Bangladesh.</li>
									<li class="second"><i class="fa fa-phone" aria-hidden="true"></i>+8801303279573</li>

									<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:maria@example.com">itshasanhero@gmail.com</a></li>
								</ul>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					...
					<ul id="m_nav_list" class="m_nav menu__list">
						...
						<li class="m_nav_item menu__item" id="moble_nav_item_5"> <a href="gallery.php" class="menu__link">Departments</a> </li>
...
<!-- /girds_agileits -->
	<div class="Department_girds_agileits">
		<div class="agile_team_grid">
			<?php
				$sql = "SELECT * FROM department WHERE status=1 order by id ASC";
			 ...
			 ?>
					...
					<div class="col-md-3 w3ls_banner_bottom_grid">
						<img src="../image/department/<?= $row['image']; ?>" alt=" " class="img-responsive" />
						<div class="overlay">
							<h4><?= $row['name']; ?></h4>
	...
	<div class="agile_menu" id="menu">
		...
		<div class="menu_w3ls_agile_top_section">
			<div class="ziehharmonika">
				<?php
					$sql = "SELECT * FROM departments WHERE status=1 order by id ASC";
					$query = mysqli_query($conn,$sql);
			...
			<div>
				  <div class="w3_agile_recipe-grid">
								...
								<div class="col-md-6 col-sm-6 tab-image">
									<img src="../image/departments/<?= $row['image']; ?>" alt="Medicinal">
								</div>
